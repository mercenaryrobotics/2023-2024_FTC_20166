...
public class SubSystemVariables {
    public static int INTAKE_LIFT_POS_0 = 143;
    public static int INTAKE_LIFT_POS_1 = 5;
    public static int INTAKE_LIFT_POS_2 = 0;
    public static int INTAKE_LIFT_POS_3 = 800;

    public static double CLAW_ARM_POWER = 0.3;
    public static int CLAW_ARM_POS_0 = 450;
    public static int CLAW_ARM_POS_1 = 5;
    ...
    public static double HANG_LIFT_DROP_POWER = 0.1;
